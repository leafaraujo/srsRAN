...
def add_user(imsi, key="FEC86BA6EB707ED08905757B1BB44B8F", op=None,
             opc="C42449363BBAD02B66D16BC975D77CC1", amf="8000", apn="lance", qci="5", ip_alloc=""):
...
def read_from_string(sub_data):
    ...
    Example string: "001010123456780,FEC86BA6EB707ED08905757B1BB44B8F,opc,C42449363BBAD02B66D16BC975D77CC1,8000,9,10.45.1.2"
    '''
...
@click.option("--subscriber_data", default="001010123456780,FEC86BA6EB707ED08905757B1BB44B8F,opc,C42449363BBAD02B66D16BC975D77CC1,8000,9,10.45.1.2", help="Single subscriber data string or full path to subscriber data csv-file.")
